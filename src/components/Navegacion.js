	...
	return (
		<Layout className="layout">
			...
			<div className="menuCon" style={{backgroundColor: 'white'}}>
				<div className="row">					
					<Menu className="top-menu-responsive w-100" theme="light" mode="horizontal" defaultSelectedKeys={[ window.location.pathname ]}>					
						<Menu.Item className="pr-2">
							<Button type="link" className="mb-3 pr-2 d-flex justify-content-center align-items-center barsMenu" onClick={showDrawer}>
						...
						<Badge count={1} className="ml-2">
							<ShoppingCartOutlined style={{fontSize: 28}} /><Link to="/shopping_cart" />
						</Badge>
					</Menu>
				</div>
				<Menu className="top-menu float-right" theme="light" mode="horizontal" defaultSelectedKeys={[ window.location.pathname ]}>
					<Search
						placeholder="input search text"
						onSearch={(value) => console.log(value)}
						style={{ width: 350 }}
