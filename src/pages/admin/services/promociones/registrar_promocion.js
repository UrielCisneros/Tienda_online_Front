...
import { Button, Input, Space, Upload, List, Spin, Avatar, message} from 'antd';
...
const RegistrarPromocion = () => {
	...
	const render = productosFiltrados.map((productos) => (
		...
		>
			<List.Item.Meta
				avatar={
					<Avatar size={40} src={`https://prueba-imagenes-uploads.s3.us-west-1.amazonaws.com/${productos.imagen}`} />
				}
        ...
        <div>
            <div className="d-lg-flex d-sm-block mt-4">
				<div className="col-12 col-lg-6">
					...
					/>
					{loading ? <Spin size="large" /> : <List>{render}</List>}
				</div>
				{content === false ? <div className="col-12 col-lg-6 d-flex justify-content-center mt-5"><h5>Selecciona un producto</h5></div> :
				<div className="col-12 col-lg-6">
					<div className="shadow">
						...
						<div className="precio-box"> 
							...
							<div>
								...
								<h3 className="precio-rebaja d-inline mr-2">${new Intl.NumberFormat().format(promocion.precioPromocion)}</h3>
							</div> :
							<h3 className="precio-rebaja d-inline mr-2">${new Intl.NumberFormat().format(producto.precio)}</h3>
						}	
						</div>
					</div>
					<div className="mt-4">
						...
						<div className="mt-4 row">
							...
							<div className="imagen-box-promocion shadow-sm border">
								<img className="img-producto-promocion" alt="img-producto" src={`https://prueba-imagenes-uploads.s3.us-west-1.amazonaws.com/${imagen}`} /> 
							</div>:
							<div></div>
							}
						</div>
